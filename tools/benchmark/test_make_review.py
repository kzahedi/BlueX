...
class RenderTest(unittest.TestCase):
    ...
    def test_bsky_url_conversion(self):
        uri = "at://did:plc:examplehandle000000000000/app.bsky.feed.post/3exampleposti0"
        self.assertEqual(
            make_review._bsky_url(uri),
            "https://bsky.app/profile/did:plc:examplehandle000000000000/post/3exampleposti0",
        )
